...
**PilotSuite** — Privacy-first, lokaler KI-Assistent für Home Assistant mit Brain Graph, Habitus Pattern Learning, Mood Engine und Predictive Automation. Aktuelle Release-Linie: **v13.10.0**.
...
PilotSuite benötigt das **PilotSuite Core Backend** (separates Add-on, aktuelle Test-Release-Linie **v13.10.0**):
