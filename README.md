...
**PilotSuite** — Privacy-first, lokaler KI-Assistent für Home Assistant mit Brain Graph, Habitus Pattern Learning, Mood Engine und Predictive Automation.
...
PilotSuite benötigt das **PilotSuite Core Backend** (separates Add-on):
