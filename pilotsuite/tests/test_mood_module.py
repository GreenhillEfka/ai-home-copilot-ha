...
# Import DOMAIN
from custom_components.copilot_ha.const import DOMAIN
...
class TestMoodModule:
    ...
    def mock_ctx(self, mock_hass, mock_entry):
        ...
        from custom_components.copilot_ha.core.module import ModuleContext
        return ModuleContext(hass=mock_hass, entry=mock_entry)

    def test_module_name(self):
        """Test that module returns correct name."""
        from custom_components.copilot_ha.core.modules.mood_module import MoodModule
...
class TestMoodModuleCharacterIntegration:
    ...
    async def test_character_service_connection(self):
        ...
        from custom_components.copilot_ha.core.modules.mood_module import MoodModule
        from custom_components.copilot_ha.core.character.service import CharacterService
