...
Usage:
  ...
  area_zone_map = load_area_zone_map()
"""
...
async def async_load_area_zone_map(hass: HomeAssistant) -> dict[str, Any]:
    """Load area-to-zone mapping without blocking the HA event loop."""
    return await hass.async_add_executor_job(load_area_zone_map)
