...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"stt": {"engine": "whisper"}}, "stt_engine", "whisper"),
        ({"stt": {"model": "whisper-large-v3"}}, "stt_model", "whisper-large-v3"),
        ({"tts": {"engine": "edge-tts"}}, "tts_engine", "edge-tts"),
        ({"tts": {"voice": "de-DE-KatjaNeural"}}, "tts_voice", "de-DE-KatjaNeural"),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            {
                "ok": "yes",
                "stt": {"available": "true", "engine": 123, "model": "  whisper-large-v3  "},
                "tts": {"available": None, "voice": "  de-DE-KatjaNeural  ", "provider": "  edge-tts  "},
