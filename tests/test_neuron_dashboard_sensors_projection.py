"""Projection contract tests for neuron_dashboard sensors.
...
class NeuronDashboardSensorContract:
    ...
    def __init__(self, coordinator):
        ...
        self._neurons = coordinator.data.get("neurons", {})
