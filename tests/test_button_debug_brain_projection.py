"""Contract tests for button_debug_brain.py projection parity."""
import ast
import pytest

from pathlib import Path

SRC = Path("/config/clawd/team/worktrees/pilotsuite-styx-ha-current/custom_components/pilotsuite/button_debug_brain.py")
...
def test_all_bdb_contracts():
    BDB1().test_unique_ids_are_pilotsuite_prefixed()
    BDB2().test_no_stale_copilot_ha_in_notification_ids()
    BDB3().test_no_unexplained_copilot_ha_literals()
