"""
Contract test: styx-chat-card.js Projection Parity (HA-379)
Source-Guard for canonical pilotsuite core API lookup in the chat card frontend.
"""
import re
...
def test_styx_chat_card_getcoreurl_pilotsuite_first():
    """SCC1: _getCoreUrl resolves pilotsuite_core_api_v1 before copilot_ha_core_api_v1."""
    path = "custom_components/pilotsuite/www/styx-chat-card.js"
...
def test_styx_chat_card_getcoreurl_keeps_copilot_ha_fallback():
    """SCC2: _getCoreUrl keeps copilot_ha_core_api_v1 as the secondary fallback."""
    path = "custom_components/pilotsuite/www/styx-chat-card.js"
    content = open(path, encoding="utf-8").read()
