...
class TestModuleImports:
    ...
    def test_import_energy_context(self):
        ...
        try:
            from custom_components.copilot_ha import energy_context
    ...
    def test_import_unifi_context(self):
        ...
        try:
            from custom_components.copilot_ha import unifi_context
    ...
    def test_import_weather_context(self):
        ...
        try:
            from custom_components.copilot_ha import weather_context
    ...
    def test_import_core_modules(self):
        ...
        for name in module_names:
            try:
                module = __import__(
                    f"custom_components.copilot_ha.core.modules.{name}",
                    fromlist=[name]
                )
...
class TestCoordinatorPattern:
    ...
    @patch('custom_components.copilot_ha.energy_context.AIHomeCopilotEnergyDataUpdateCoordinator')
    def test_energy_coordinator_init(self, mock_coordinator_class):
        ...
        from custom_components.copilot_ha.energy_context import (
    ...
    @patch('custom_components.copilot_ha.unifi_context.AIHomeCopilotUniFiDataUpdateCoordinator')
    def test_unifi_coordinator_init(self, mock_coordinator_class):
        ...
        from custom_components.copilot_ha.unifi_context import (
            AIHomeCopilotUniFiDataUpdateCoordinator
        )
        
        assert callable(AIHomeCopilotUniFiDataUpdateCoordinator)

    @patch('custom_components.copilot_ha.weather_context.AIHomeCopilotWeatherDataUpdateCoordinator')
    def test_weather_coordinator_init(self, mock_coordinator_class):
        ...
        from custom_components.copilot_ha.weather_context import (
...
class TestEntityValidation:
    ...
    def test_unifi_sensor_entities_config(self):
        ...
        unifi_entities = {
            "sensor.copilot_ha_unifi_clients_online": {
                "state_class": "measurement",
                "unit_of_measurement": "clients"
            },
            "sensor.copilot_ha_unifi_wan_latency": {
                "state_class": "measurement",
                "unit_of_measurement": "ms"
            },
            "binary_sensor.copilot_ha_unifi_wan_online": {
    ...
    def test_weather_sensor_entities_config(self):
        ...
        weather_entities = {
            "sensor.copilot_ha_weather_temperature": {
                "state_class": "measurement",
                "unit_of_measurement": "°C",
                "device_class": "temperature"
            },
            "sensor.copilot_ha_weather_cloud_cover": {
                "state_class": "measurement",
                "unit_of_measurement": "%",
                "device_class": "null"
            },
            "sensor.copilot_ha_pv_forecast_kwh": {
                "state_class": "total",
                "unit_of_measurement": "kWh",
                "device_class": "energy"
            }
