...
from custom_components.copilot_ha.core.mupl.action_attribution import (
    ActionAttributor,
    AttributionResult,
    UserAction,
    PresenceAttribution,
...
class TestTimePatternAttribution:
    ...
    async def test_morning_pattern(self, hass):
        ...
        with patch('custom_components.copilot_ha.core.mupl.action_attribution.dt_util') as mock_dt:
