...
class TestCrossHomeClient:
    ...
    def test_initialization(self):
        ...
        from custom_components.copilot_ha.cross_home_sync import CrossHomeClient
    ...
    async def test_unshare_entity(self):
        ...
        from custom_components.copilot_ha.cross_home_sync import (
            CrossHomeClient,
            SharedEntity,
        )
...
class TestSharedEntity:
    ...
    def test_shared_entity_creation(self):
        ...
        from custom_components.copilot_ha.cross_home_sync import SharedEntity
