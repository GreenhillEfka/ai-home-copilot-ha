...
class StyxZoneCard extends _ZoneBase {
    ...
    return [
      {
        ...
        sectionHelp: 'Choose the sensor entity that provides the canonical zone summary payload for this card. Keep the default unless you have a compatible replacement sensor with the same zone payload shape.',
        example: 'sensor.copilot_ha_habitus_zones',
      },
      {
        name: 'title',
        label: 'Title',
        ...
        sectionHelp: 'Set the visible card title without changing the underlying zone source. Leave the default for a neutral header, or rename it to match the dashboard context.',
        example: 'Wohnzonen',
      },
      {
        name: 'show_mood',
        label: 'Show mood gauges',
        section: 'Visible panels',
        sectionHelp: 'Toggle which zone insight panels stay visible in the card UI. Recommended panels keep the at-a-glance view balanced without changing any zone logic or data source behavior.',
        selector: 'boolean',
        default: true,
        help: 'Shows comfort, joy, and frugality gauges for each zone.',
      },
      {
        name: 'show_neuron_activity',
        label: 'Show neuron activity',
        section: 'Visible panels',
        selector: 'boolean',
        default: true,
        help: 'Shows the zone-level neuron activity summary when graph sensor data is available.',
      },
      {
        ...
        default: true,
        recommended: true,
        help: 'Shows one-tap actions for common zone interactions.',
        recommendation: 'Recommended for the default editor setup so the card stays actionable without drilling into other views.',
      },
      {
        ...
        default: true,
        recommended: true,
        help: 'Shows the zone health badge sourced from the existing health sensor.',
        recommendation: 'Recommended for the default editor setup to preserve quick health scanning across zones.',
      },
      {
        name: 'show_module_states',
        label: 'Show module states',
        section: 'Visible panels',
        selector: 'boolean',
        default: true,
        help: 'Shows state chips for zone modules such as light or music availability.',
      },
      {
        name: 'show_autonomy_log',
        label: 'Show autonomy log',
        section: 'Visible panels',
        selector: 'boolean',
        default: true,
        help: 'Shows the recent autonomy action mini-log for each zone.',
      },
      {
        name: 'show_presence_hold',
        label: 'Show presence hold',
        section: 'Visible panels',
        selector: 'boolean',
        default: true,
        recommended: true,
        help: 'Shows the presence hold indicator when the zone exposes that state.',
        recommendation: 'Recommended for the default editor setup so manual or automated hold state remains visible alongside actions and health.',
      },
    ];
  }
  ...
  _callPresenceHoldService(zoneId, hold) {
    ...
    try {
      this._hass.callService('copilot_ha', 'set_zone_presence_hold', {
