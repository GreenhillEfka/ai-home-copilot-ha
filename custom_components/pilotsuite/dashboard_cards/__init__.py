...
def __getattr__(name: str):
    ...
    # === Existing cards (root level) ===
    if name == "create_energy_distribution_card":
        from .energy import energy_distribution_card
        return energy_distribution_card.create_energy_distribution_card
    ...
    if name == "create_mesh_network_health_card":
        from .mesh.mesh_monitoring_card import create_mesh_network_health_card
        return create_mesh_network_health_card
    if name == "create_battery_overview_card":
        from .mesh.mesh_monitoring_card import create_battery_overview_card
        return create_battery_overview_card
    if name == "get_mesh_data_from_hass":
        from .mesh.mesh_monitoring_card import get_mesh_data_from_hass
        return get_mesh_data_from_hass
    if name == "MeshNetworkData":
        from .mesh.mesh_monitoring_card import MeshNetworkData
        return MeshNetworkData
    
    # === Data classes (root level) ===
    ...
    if name == "create_presence_card":
        from .presence.presence_activity_cards import create_presence_card
        return create_presence_card
    if name == "create_activity_card":
        from .presence.presence_activity_cards import create_activity_card
        return create_activity_card
    
    # === Energy (energy/) ===
    if name == "create_energy_card":
        from .energy.energy_media_cards import create_energy_card
        return create_energy_card
    if name == "create_media_card":
        from .energy.energy_media_cards import create_media_card
        return create_media_card
    
    # === Weather (weather/) ===
    if name == "create_weather_card":
        from .weather.weather_calendar_cards import create_weather_card
        return create_weather_card
    if name == "create_calendar_card":
        from .weather.weather_calendar_cards import create_calendar_card
        return create_calendar_card
    
    # === Overview Dashboard (overview/) ===
    if name == "create_complete_dashboard":
        from .overview.overview_dashboard import create_complete_dashboard
        return create_complete_dashboard
    if name == "create_mobile_dashboard":
        from .overview.overview_dashboard import create_mobile_dashboard
        return create_mobile_dashboard
    if name == "dashboard_to_yaml":
        from .overview.overview_dashboard import dashboard_to_yaml
        return dashboard_to_yaml
    
    # === Interactive (interactive/) ===
    if name == "create_neuron_detail_card":
        from .interactive.interactive_dashboard import create_neuron_detail_card
        return create_neuron_detail_card
    if name == "create_neuron_grid_card":
        from .interactive.interactive_dashboard import create_neuron_grid_card
        return create_neuron_grid_card
    if name == "create_filter_card":
        from .interactive.interactive_dashboard import create_filter_card
        return create_filter_card
    if name == "create_zone_filter_card":
        from .interactive.interactive_dashboard import create_zone_filter_card
        return create_zone_filter_card
    if name == "create_status_filter_card":
        from .interactive.interactive_dashboard import create_status_filter_card
        return create_status_filter_card
    if name == "create_neuron_detail_view":
        from .interactive.interactive_dashboard import create_neuron_detail_view
        return create_neuron_detail_view
    if name == "create_zone_detail_view":
        from .interactive.interactive_dashboard import create_zone_detail_view
        return create_zone_detail_view
    if name == "create_info_modal":
        from .interactive.interactive_dashboard import create_info_modal
        return create_info_modal
    if name == "create_confirm_dialog":
        from .interactive.interactive_dashboard import create_confirm_dialog
        return create_confirm_dialog
    if name == "create_filterable_dashboard":
        from .interactive.interactive_dashboard import create_filterable_dashboard
        return create_filterable_dashboard
    
    # === Mobile (mobile/) ===
    if name == "ResponsiveConfig":
        from .mobile.mobile_responsive_dashboard import ResponsiveConfig
        return ResponsiveConfig
    if name == "create_responsive_grid":
        from .mobile.mobile_responsive_dashboard import create_responsive_grid
        return create_responsive_grid
    if name == "create_adaptive_card":
        from .mobile.mobile_responsive_dashboard import create_adaptive_card
        return create_adaptive_card
    if name == "create_adaptive_stat_card":
        from .mobile.mobile_responsive_dashboard import create_adaptive_stat_card
        return create_adaptive_stat_card
    if name == "get_theme_colors":
        from .mobile.mobile_responsive_dashboard import get_theme_colors
        return get_theme_colors
    if name == "apply_theme_styles":
        from .mobile.mobile_responsive_dashboard import apply_theme_styles
        return apply_theme_styles
    if name == "create_touch_card":
        from .mobile.mobile_responsive_dashboard import create_touch_card
        return create_touch_card
    if name == "create_swipeable_card":
        from .mobile.mobile_responsive_dashboard import create_swipeable_card
        return create_swipeable_card
    if name == "create_mobile_overview_layout":
        from .mobile.mobile_responsive_dashboard import create_mobile_overview_layout
        return create_mobile_overview_layout
    if name == "create_mobile_dashboard_layout":
        from .mobile.mobile_responsive_dashboard import create_mobile_dashboard_layout
        return create_mobile_dashboard_layout
    if name == "create_responsive_sensor_card":
        from .mobile.mobile_responsive_dashboard import create_responsive_sensor_card
        return create_responsive_sensor_card
    if name == "create_complete_mobile_dashboard":
        from .mobile.mobile_responsive_dashboard import create_complete_mobile_dashboard
        return create_complete_mobile_dashboard
    if name == "create_theme_switcher_card":
        from .mobile.mobile_responsive_dashboard import create_theme_switcher_card
