"""PilotSuite Styx Permission — HA-394.
Auto-Sync Core: /api/v1/permissions/*
"""
...
async def async_setup_entry(hass, config_entry, async_add_entities):
    ...
    async_add_entities([CorePermissionSensor(core_url)])
class CorePermissionSensor(SensorEntity):
    ...
    def update(self):
        ...
        if resp.status_code == 200:
            self._attr_native_value = len(resp.json().get("permissions", []))
