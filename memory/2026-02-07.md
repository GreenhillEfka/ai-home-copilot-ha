...
- Beschreibt ausschließlich den Entstehungsdruck des PilotSuite.
...
**Ziel dieses Kapitels:** Die bisherigen Kapitel logisch schließen (nicht nur zusammenfassen), Widersprüche ausräumen und das Gesamtkonzept des PilotSuite als normative Referenz festschreiben. Leitfrage: „Was ist dieses System – und was darf es niemals werden?“
...
- PilotSuite = kein steuerndes System, sondern erklärendes, begrenztes, dialogisches Entscheidungssystem.
...
**Ziel dieses Kapitels:** Abschließende, konsolidierte Referenz aller Mood-Module (explizit/implizit aus Verläufen). Definiert den semantischen Zustandsraum, den der PilotSuite interpretieren kann.
...
**Ziel dieses Kapitels:** Festlegen, was der PilotSuite ausdrücklich nicht ist/werden darf und nicht leisten soll, selbst wenn es technisch möglich oder kurzfristig bequem wäre. Schutzschild gegen schleichende Konzeptzerstörung.
