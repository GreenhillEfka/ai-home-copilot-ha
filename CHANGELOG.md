...
**Ziel:** Smoke-Test-Dokumentation auf tatsächliche Version synchron halten.

#### Changed

- **Smoke Test Version:** `smoke_test_v15.py` Docstring auf `v15.0.2` aktualisiert (keine Funktionsänderung).
